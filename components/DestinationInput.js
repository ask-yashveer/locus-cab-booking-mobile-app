...
export default class DestinationInput extends React.Component {
	...
	submitDestination = (e) => {
		...
		// displays polyline for entered origin to destination
		DirectionsAPI.getDirections(this.state.origin, this.state.destination, (coords) => {this.state.coordsCb(coords)})

		// displays example polyline 
